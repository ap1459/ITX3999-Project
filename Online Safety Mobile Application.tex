...
\begin{itemize}
	...
	\item The quiz should be more user-friendly, in terms of having larger buttons to make clicking on answers easier
...
The previous navigation sidebar was not in line with how modern mobile applications have theirs, therefore this was changed and improved to reflect the modern look for them.

\section{Evaluation}

Users felt the RSS feed now appearing on a separate page made the application seem tidier and preferred having the dedicated page.

The users were grateful that now they could tell which answers they had got right or wrong, therefore they could actually learn from their mistakes. The drawback of this is that since at this stage of the app, the quiz has been kept relatively short, therefore they could learn all the answers. The only appropriate way to fix this is create perhaps an array of many questions, whereby questions would be randomly presented to the user.

\section{Project Conclusion}

Having now completed this project, I have learnt a variety of lessons, in regard to programming the actual application, as well as around the topic of online safety itself.
...
If I had more time, I would like to have improved the quiz section somewhat, and perhaps implement the JavaScript array of questions which allow for random questions to be presented to the user.

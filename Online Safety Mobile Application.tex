...
\author{Andreas Pavlou - M00536572}
\title{ITX3999 Final Report - Online Safety Mobile Application}
\date{27/04/2018}
...
The following work is the culmination of an academic years worth of work attempting to build a hybrid mobile application on the topic of online safety. It focuses on particular themes, such as safety in regard to the use of social media, online messengers, and so on. Originally it was to be targeted to a younger audience, though after discussion with a charity, it was deemed more suitable to an audience of secondary school age and upwards. The application also features quizzes to test users learning, as well as an RSS feed to deliver to them the latest news regarding hacks and general IT security developments. The application went through three iterations, beginning with a paper prototype, followed by a working prototype with minimal function, with the final iteration being the finished product. At each stage it was evaluated by three separate users, from which their critiques would go on to shape how the application would be.
...
\cite{association_number_2014}, it is imperative that online safety is taught to ordinary people who may not be particularly well-versed in the best safety practices. Individuals between the ages of 18 to 29 make up 83\% of social media users and 43\% of this age bracket believe that their personal data is less safe than compared with five years ago, a study  \cite{pew_research_2012} has shown. This report proposes that a different approach is taken to teach online safety, and it should be that of a mobile application. The objective of this application is to help teach people about how to be safe online, with a focus on social media such as Facebook, Twitter, and so on. It will also cover instant messaging services such as WhatsApp, as well as offer guidance to help people deal with cyberbullying. In order to better test their knowledge and reinforce learning, quizzes will be implemented to test what users know and have learned.
...
\centering
\caption{Screenshot UK Safer Internet Center's social media page}
\end{figure} 
...
%This command makes a subsubsubsection possible
...
\subsubsection{Charity Responses}
...
The prototype application has been created utilising PhoneGap, and has been programmed in HTML, CSS and JavaScript. On each and every HTML page, within the code is some default code that is included to allow fro PhoneGap functionality, and this is code included in the head tag. There are also some default CSS code within the stylesheet that sets out the default look for the app, as well as how the app looks when it connects to the server and when the user manually refreshes the page, via a three finger tap to the screen. The JavaScript file for the project also includes some default code that allows for our mobile application to work with the PhoneGap server. A handful of API's have also been made use-of, including one for the RSS feed, as well as Google Charts API which allows for the creation of pie charts to show the results of quizzes the user has completed. The screenshots shown have been taken whilst the application has been in use on an iPhone 5S.
...
\centering
\caption{Social media first page}
...
\centering
\caption{Social media second page}
...
The evaluation given by the respondents in the previous section have been listened to and implemented in order to create the third and final iteration of the online safety mobile application. Some changes have been made in regards to the layout also, to make it more in line with modern mobile applications, as well as to improve the overall user experience.

\subsection{User Requirements} 

For the final round of user requirements, the points made by the respondents in the evaluation section of the previous iteration will be taken into account, in order to identify what the requirements are. The following points are the requirements as specified in the previous evaluation - 

\begin{itemize}
	\item The RSS page should be on a separate page
	\item The quiz should show what questions they had got right or wrong
	\item The app must look just as good in landscape mode
\end{itemize}

Feedback from the project supervisor also stressed that improvements to the look and feel of the user interface would be beneficial, as at its stage in the second iteration, it was perhaps too plain, and it was stated that a simple design, need not be plain as such. Another key point was made that, whilst the extra features being implemented in, such as the RSS feed are a nice addition, the purpose of the application must not be forgotten, overlooked, or take a back-seat and the majority of the focus should be on delivering what was specified the app should deliver, at the beginning of this projects inception.

\subsection{Design \& Implementation}

Just like the second iteration, the following screenshots will demonstrate what the application now looks like on an iPhone 5S. The colour scheme and theme has been kept the same though some changes have been made.

\begin{figure} [H]
\includegraphics[scale=0.3]{ThirdIterationNews}
\centering
\caption{Seperate RSS Feed}
\end{figure} 

The RSS feed is now only available on a separate page, as it was simply too cluttered on the homepage, and as the users stated, they would prefer a separate page for it.

\begin{figure} [H]
\includegraphics[scale=0.3]{ThirdIterationQuiz}
\centering
\caption{Social media quiz showing right and wrong answers}
\end{figure} 

When the user has finished the quiz and hits 'Submit', it will now alert them if they got any answer right or wrong. This will allow user to learn from their mistakes.

\begin{figure} [H]
\includegraphics[scale=0.3]{ThirdIterationMainMenu}
\centering
\caption{Main Menu}
\end{figure} 

It was decided that the buttons users click on to navigate from one part of the application to the other were a little small, and did not look professional. Therefore drawing on inspiration from other applications, the size was increased to make it take more room, also making it easier for users to click on it. New icons for the main menu were added to make it clear what the user was navigating to with just a glance.

\begin{figure} [H]
\includegraphics[scale=0.3]{ThirdIterationMenuNav}
\centering
\caption{Main Menu with navigation bar}
\end{figure} 

The side-navigation bar as it was in the second iteration was deemed too simple and not up-to standard mobile application quality, therefore some changes were made to make it more in line with modern applications. Users can still navigate to the Home of the application, or to the About page which features a small paragraph summing up why the application was made.

\begin{figure} [H]
\includegraphics[scale=0.3]{ThirdIterationSocialLand}
\centering
\caption{Social Media page in landscape}
\end{figure} 

\begin{figure} [H]
\includegraphics[scale=0.3]{ThirdIterationSocialNav}
\centering
\caption{Social Media page with navigation bar}
\end{figure} 

Some changes were made in order to accommodate the application in landscape mode, and for the time being it was focused solely on landscape mode on an iPhone 5S. There is no dramatic change between landscape and portrait now, which is preferable to allow a seamless experience for users.

\begin{figure} [H]
\includegraphics[scale=0.3]{ThirdIterationFacebook}
\centering
\caption{Facebook topic page updated}
\end{figure} 

\begin{figure} [H]
\includegraphics[scale=0.3]{ThirdIterationFacebookTwo}
\centering
\caption{More of Facebook topic page}
\end{figure} 

\begin{figure} [H]
\includegraphics[scale=0.3]{CyberbullyingShot}
\centering
\caption{Segment of the cyberbullying section}
\end{figure} 


The topic pages were refined and had extra design added to them in order to make them look better and not just simply walls of text. Utilising the same colour scheme in order to keep continuity within the application

\subsection{Evaluation}

The users were called upon one final time to give feedback regarding the application at this final stage. The users were once again given the opportunity to use the application via a supplied iPhone 5, and were asked if they felt the app had met, or at least partially met the requirements that were discussed and agreed upon in the first iteration, and these were -
...
Users felt the RSS feed now appearing on a separate page made the application seem tidier and preferred having the dedicated page. Users also stated that the change to the navigation buttons was a welcome one, and made the overall look of the application far more professional than before. The changes made to the navigation bar were also appreciated, as users stated it was easier to operate than the one in the previous iteration.

The users were grateful that now they could tell which answers they had got right or wrong, therefore they could actually learn from their mistakes. The drawback of this is that since at this stage of the application, the quiz has been kept relatively short, therefore they could learn all the answers. Respondents also felt the application worked far better in landscape mode than before, as it was somewhat messy before whereas now it performed just as well whether it was in portrait or landscape.

Referring back to the tasks given to users in the second iteration evaluation, users were asked to complete two tasks where previously there was some issue, and these were -

\begin{enumerate}
	\item Navigate to the quiz section and complete a quiz
	\item Repeat step 1 but in landscape mode
\end{enumerate}

With the changes made to how the application looks in landscape mode, task 2 was far easier for users to do than before, and now that the quiz states which questions were right and wrong, users found this to be more helpful.

\section{Project Conclusion}

Having now completed this project, I have learnt a variety of lessons, in regard to programming the actual application, as well as around the topic of online safety itself. I have learned that there is a lot to be said for online safety especially across the multitude of social media platforms available, and that ways in which users can go about protecting their personal identity are not always obvious. In regard to programming, I had to overcome a significant learning curve in the form of utilising developmental technologies, such as PhoneGap. I have learned creating an application suitable for mobiles was not as straightforward as I had imagined, especially compared to making a standard/generic website for a computer browser.

If I had more time, I would like to have improved the quiz section somewhat, perhaps implementing a JavaScript array of questions which allow for random questions to be presented to the user each time, so there would be less of an opportunity to learn all the answers. I would've liked to have implemented perhaps a timed quiz, where users have a certain amount of time to submit their answers, this would added an extra layer of difficulty and really challenged them. On a functionality level I would've liked to have implemented more touch-functions to take full advantage of the mobile functionality, though I do not believe the lack of this, is a particularly detrimental to the overall objective of the application. 

I believe the future work for this project, would involve perhaps altering it to make it suitable for a younger audience of 13 and below. This is not without its hurdles, considering what we have learned from the charity responses in section 4.1.1, this simply is something that children don't tend to take an interest in, therefore a new approach must be considered in order to gauge their interest in learning about a topic that is increasingly important. Perhaps implementing some form of video game on the app to get kids interested in learning about a topic they don't seem to find interesting, as our charity responses have told us. There is also the issue of would this be targeted to just the younger age demographic, or should it be for anyone and everyone? Perhaps the application could have two sections, one for adults with more in depth information, and a section for kids with easy to understand and bitesize information.

On a personal note, this project has been incredibly insightful for a number of reasons; I have learnt just how much there is to learn in regard to online safety, and that while some guidelines may sound obvious, it is clear that there is an ever-increasing threat of online problems that future generations need to learn about, and prepare for. I have also enjoyed programming the application, though I found it at times to be quite difficult, it was interesting to learn how to use PhoneGap and create the application using HTML, CSS and JavaScript, as it meant I could build upon the skills I had learned in my previous university years of study.
...
\subsection{How to use OSCAR}

The OSCAR mobile application can be viewed without the use of the PhoneGap server if one wishes. Simply navigate to the project folder, then to the 'www' folder and open the index.html with a web browser. Please note you would have to resize the browser window to mimc a mobile device. If however you would like to make use of the full functionality, you will need to run the PhoneGap server, which the following guide will explain how to do. It will also explain how to run the application with an accompanying mobile device.

\begin{enumerate}
	\item Navigate to http://docs.phonegap.com/getting-started/1-install-phonegap/cli/ 
	\item Install node.js and git if you do not already have them
	\item Navigate to http://docs.phonegap.com/getting-started/1-install-phonegap/desktop/ 
	\item Install PhoneGap via the relevant installer for your operating system
\end{enumerate}

There are two possible ways of running the server now, either via the PhoneGap desktop app, or through the command line - 

\subsubsection{Command Line}
\begin{enumerate}
	\item Drag and drop OSCAR project folder onto desktop
	\item Open terminal/command line
	\item Navigate to the Desktop using terminal/command line (i.e. cd Desktop)
	\item Navigate to the OSCAR project folder via terminal (i.e. cd OSCAR)
	\item Type "phonegap serve" to start the server
	\item Make note of the address (i.e. 192.168.1.11:3000)
	\item Copy and paste address into web browser to view on browser
\end{enumerate}

\subsubsection{PhoneGap Desktop App}
\begin{enumerate}
	\item Run PhoneGap desktop application
	\item Drag and drop OSCAR project folder into PhoneGap or click the top left plus icon, then click open existing PhoneGap project, and then open OSCAR
	\item Click the arrow to the right to run the server (Press the square to stop)
	\item At the bottom it should tell you the server is running, click on that to open via browser, or copy and paste the link into a browser
\end{enumerate}

\begin{figure} [H]
\includegraphics[scale=0.7]{PhoneGapGuide}
\centering
\caption{PhoneGap interface}
\end{figure} 

\subsection{PhoneGap on Device}

If you wish to view the mobile application via a mobile device or tablet, you will need to go to your devices relevant app store and download PhoneGap. Then you will need to -

\begin{enumerate}
	\item Make sure the server is running via your PC/Laptop
	\item Open the PhoneGap app on your mobile
	\item Make sure your device and PC/Laptop are on the same network
	\item Check the server address shown on the PhoneGap mobile app matches the server shown on the PhoneGap application on your PC/Laptop
	\item Hit 'Connect' and the it should download the project, allowing you to view the app on your device
\end{enumerate}

\begin{figure} [H]
\includegraphics[scale=0.7]{PhoneGapGuide2}
\centering
\caption{PhoneGap mobile device interface}
\end{figure} 

If more instructions are required, please make use of this resource - \href{http://docs.phonegap.com/getting-started/4-run-your-app/cli/}{Click here} or alternatively copy and paste this link - http://docs.phonegap.com/getting-started/4-run-your-app/cli/ . It may produce an error upon copy and pasting, if it does check the syntax of the address as it may arbitrarily add a space, which makes the connection 404. Upon clicking this link it may also only show half of the address in the address bar, if so please copy and paste the remainder of the address and double check the syntax.


\subsection{GitHub Repository}

The following link is to the GitHub repository where the mobile application is stored. The repository also includes the files used to create this report in TexShop -  https://github.com/ap1459/ITX3999-Project

The contents of the OSCAR project folder, including the HTML, CSS and JavaScript were all written by me with the exception of -

\begin{itemize}
	\item Some default code that appears on top the of every HTML page to allow the app to work with PhoneGap server - contained within the head element
	\item Default JavaScript code that allows the mobile app to work with the PhoneGap server
	\item Default CSS code that is there when you begin creating an app
	\item I made use of a Google API to create the pie charts for the quiz section, the code was tailored to suit my needs
	\item I made use of an RSS to JSON API to create my news feed and the code was tailored to suit my needs
	\item The 'spec' folder, the spec.html file and the 'res' folder, which are default made when using PhoneGap
	\item When running the app via the PhoneGap server,  loading a page may show the PhoneGap default logo, which is included in the image folder. This is of course a default supplied image.
\end{itemize}
